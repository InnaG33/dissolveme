...
y_data=pd.read_csv("https://dissolveme-ds.s3.us-east-2.amazonaws.com/y_model.csv")
del X_data['Unnamed: 0']
del y_data['Unnamed: 0']

solvents_info=pd.read_csv("https://dissolveme-ds.s3.us-east-2.amazonaws.com/solvents_info.csv")

# get element dictionary set  
element_info = pd.read_csv("https://dissolveme-ds.s3.us-east-2.amazonaws.com/element_info.csv")
...
def read_polymers():
    ...
    polymer_info = pd.read_csv("https://dissolveme-ds.s3.us-east-2.amazonaws.com/polymer_info.csv")
    ...
    for i in range(len(polymers)): 
        ...
        output.append({"Molecular Formula" : structures[i]})
        output.append({"Total Mw" : Mwtot[i]})
